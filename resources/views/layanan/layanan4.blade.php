...
<div class="container mt-4">
    <ul class="nav nav-dept justify-content-center gap-4 border-bottom mb-5">
        ...
        <li class="nav-item"><a class="nav-link active" href="/rmb">RMB</a></li>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-5">
            <div class="row g-3">
                ...
                <div class="col-6"><img src="{{ asset('gambar/rmb-5.webp') }}" class="img-sub shadow"></div>
                <div class="col-6"><img src="{{ asset('gambar/rmb-6.webp') }}" class="img-sub shadow"></div>
            </div>
        </div>
    </div>
